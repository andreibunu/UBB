--g, h1(subquery in from clause)  Select the prisoners who received the longest sentence from all the inmates with the same country
...
--g, h2(subquery in from clause) Dangeours Wings:  Select the wings in which the ratio of NumberOfInmates / NumberOfDangerousInmates smaller than average, EXCEPT wing 6(with most notorious criminals)
